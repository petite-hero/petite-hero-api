...
public interface ParentChildRepository extends JpaRepository<Parent_Child, Long> {
    ...
    Parent_Child findDistinctFirstByChild_ChildIdAndParent_IdAndCollaboratorIsNull(Long childId, Long parentId);
    ...
    List<Parent_Child> findParent_ChildrenByCollaborator_Account_UsernameAndChild_IsDisabledAndIsCollaboratorConfirm(String phoneNumber, Boolean isDisabled, Boolean isCollabConfirm);
}
